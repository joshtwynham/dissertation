...
struct  X509Store_t761  : public Object_t
{
	...
	X509Certificate2Collection_t752 * ___list_2;
	...
	X509Store_t775 * ___store_4;
};
struct X509Store_t761_StaticFields{
	...
	Dictionary_2_t291 * ___U3CU3Ef__switchU24mapF_5;
};
