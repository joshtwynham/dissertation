...
struct  ClientSessionInfo_t986  : public Object_t
{
	...
	ByteU5BU5D_t751* ___sid_4;
	// System.Byte[] Mono.Security.Protocol.Tls.ClientSessionInfo::masterSecret
	ByteU5BU5D_t751* ___masterSecret_5;
};
struct ClientSessionInfo_t986_StaticFields{
