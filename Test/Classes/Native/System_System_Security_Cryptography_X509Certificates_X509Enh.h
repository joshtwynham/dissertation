...
struct  X509EnhancedKeyUsageExtension_t767  : public X509Extension_t746
{
	...
	OidCollection_t764 * ____enhKeyUsage_4;
...
struct X509EnhancedKeyUsageExtension_t767_StaticFields{
	...
	Dictionary_2_t291 * ___U3CU3Ef__switchU24mapE_6;
};
