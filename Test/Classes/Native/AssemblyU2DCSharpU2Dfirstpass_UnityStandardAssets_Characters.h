...
struct  AICharacterControl_t1  : public MonoBehaviour_t2
{
	...
	NavMeshAgent_t4 * ___U3CagentU3Ek__BackingField_3;
	...
	ThirdPersonCharacter_t5 * ___U3CcharacterU3Ek__BackingField_4;
};
